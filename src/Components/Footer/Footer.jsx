        ...
        <div>
            <footer className="flex text-white">
                <div className="bg-[#1F2937] w-1/2">
                    <div className="max-w-fit float-right p-20 text-center">
                        <h2>CONTACT US</h2>
                ...
                <div className="bg-[#111827] w-1/2">
                    <div className="max-w-fit float-left p-20 text-center">
                        <h2>Follow US</h2>
            ...
            <p className="text-center text-white p-3 bg-[#151515]">
